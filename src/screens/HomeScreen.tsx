    ...
    <div className="screen" style={{ paddingBottom: 16 }}>
      ...
      <div style={{ padding: '20px 20px 0' }}>
        ...
        <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', padding: '12px 16px', gap: 10 }}>
            ...
            <button className="btn-secondary" onClick={() => onNavigate('adjust-session')} style={{ width: 44, padding: 0, flexShrink: 0 }}>
      ...
      <div style={{ padding: '20px 20px 16px' }}>
        ...
        <button 
          ...
          style={{ width: '100%', marginTop: 16, padding: '14px', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 8 }}
        >
